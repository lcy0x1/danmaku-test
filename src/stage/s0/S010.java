...
public class S010 extends SpellCard implements Emiter.Ticker {
	...
	private static final Sprite.SParam sp0 = Sprite.getCurve(Sprite.P_SR, 11410, 1, 1);
	private static final Sprite.SParam sp1 = Sprite.getCurve(11402, 1, 1, p2 / 30, 0, false);
	private static final Sprite.SParam sp2 = Sprite.getCurve(11413, 1, 1, p2 / 30, 0, false);
	private static final Sprite.SParam sp3 = Sprite.getDot(20702, 0);

	private static final double l0 = 50, w0 = p2 / 1000, da = p2 / 4;

	private static final int[] ns = { 4, 5, 6, 7 };
	private static final int[] nxs = { 10, 11, 12, 13 };
